 ...
 */
package siarhei.luskanau.places.presentation.exception;
...
public class ErrorMessageFactory {
    ...
    public String create(Exception exception) {
        ...
        } else if (exception instanceof PlaceNotFoundException) {
            message = context.getString(R.string.exception_message_place_not_found);
        }
